...
interface PauseJobFormProps {
  ...
  mobile?: boolean;
  /** Shows the "stops tracking your time" info banner. The OFFICE view hides
   *  it — there is no time tracking there. Default true. */
  showBanner?: boolean;
}
...
export default function PauseJobForm({ open, onClose, onPause, mobile = false, showBanner = true }: PauseJobFormProps) {
  ...
  return (
    ...
    >
      <div className={styles.form}>
        ...
        {showBanner && <AlertBanner orientation="vertical">Pausing a job stops tracking your time</AlertBanner>}
