...
type Charge = { id: string; title: string; caption: string; total: string; unit: string };
type ChargeGroup = { key: string; label: string; icon: string; subtotal: string; items: Charge[] };
...
// One accordion group. Drag reorder is enabled only when the group holds more
// than one line item (Daniel's rule) — a single row has nothing to reorder.
