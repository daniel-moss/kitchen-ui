...
// Related rows (Daniel, 2026-07-22: Belongs to / Converted into / Connected to
// / Recall removed). "Recall to" mirrors the job picked in the Service module —
// rendered dynamically in the panel (hidden when no recall job is set).
...
export default function DetailsPanel({ mobile = false, scheduling, onSchedulingChange, job, locked = false, recallTo = null }: DetailsPanelProps) {
      ...
      <DisplayModule
        ...
        content={
          <div className={styles.listBody}>
            ...
            {/* Mirrors the Service module's "Recall to" pick. */}
            {recallTo != null && (
              <ListItem
                variant="titleCaptionReversed"
                title={recallTo}
