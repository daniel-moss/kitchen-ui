  ...
  return (
    ...
    >
      <div className={styles.form}>
        {/* Info alert (Figma 24042-18897): starting = time tracking begins. */}
        <AlertBanner orientation="vertical">
          Starting a job starts tracking your time. You can always pause a job, if you need to.
        </AlertBanner>
