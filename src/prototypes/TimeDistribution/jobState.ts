...
export const STATUS_TS = "Jan 1 at 12:00 PM";

const TS_DATE = new Intl.DateTimeFormat("en-US", { month: "short", day: "numeric" });
const TS_TIME = new Intl.DateTimeFormat("en-US", { hour: "numeric", minute: "2-digit", hour12: true });
/** "Jul 15 at 3:45 PM" — the real moment a status transition happened. */
