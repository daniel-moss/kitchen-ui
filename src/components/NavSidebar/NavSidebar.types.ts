...
import { WorkspaceItem } from "./NavSidebarWorkspaceButton.types";
...
export interface NavSidebarProps {
  ...
  // ---- content ----
  /** Top navigation — NavSidebarItem / NavSidebarItemGroup elements. */
  children: ReactNode;
  /** Bottom items above the Create button (e.g. Help center, What's new). */
  bottomItems?: ReactNode;

  // ---- Create button (rendered when createMenu is set) ----
   ...
   * nothing (the NavBottomBar takes over). "auto" (default) follows the
