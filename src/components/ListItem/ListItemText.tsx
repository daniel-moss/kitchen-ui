...
export default function ListItemText({ variant, title, caption, captionPlaceholder, titleLines, captionLines, titleClassName, captionClassName, captionSlotLeft, right, className }: ListItemTextProps) {
  const left = (
    <ListItemTextLeft
      variant={variant}
      title={title}
