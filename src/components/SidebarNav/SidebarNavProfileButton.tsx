...
import styles from "./SidebarNavProfileButton.module.scss";
import { SidebarNavProfileButtonProps } from "./SidebarNavProfileButton.types";
...
// SidebarNavProfileButton — the sidebar's avatar button: a 36px circle with
...
export default function SidebarNavProfileButton({
  name,
  email,
  avatarSrc,
  children,
