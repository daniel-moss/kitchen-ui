...
/**
 * The demo's fixed NOW — every "today"-relative read (past due, expired,
 * schedule horizon, date presets) measures from this, never from the real
 * clock, so lists and screenshots stay stable. Set to the moment the curated
 * stories imply (JOB-1201 is active on its Sep 4 visit). Moving it forward
 * later means re-checking the rows around it — every date in this file is an
 * absolute string on purpose.
 */
export const TODAY = new Date("2026-09-04T09:00:00");
...
export const JOBS: Job[] = [
  ...
  },
  {
    ...
    statusChangedAt: "2026-08-29T00:00:00",
  ...
  },
  {
    ...
    statusChangedAt: "2026-08-31T12:00:00",
  ...
  },
  {
    ...
    statusChangedAt: "2026-09-02T16:20:00",
  ...
  { id: "JOB-1067", locationId: "sunset-judah", serviceId: "hood-cleaning", serviceName: "Grill hood cleaning", status: "pastDue", priority: 1, scheduledFor: "2026-08-31T09:15:00", durationMinutes: 30, assigneeIds: [3], equipmentIds: [], labelIds: ["warranty", "contract"], type: "recall", sourceId: "direct", receivedAt: "2026-08-25T09:45:00", statusChangedAt: "2026-08-26T17:00:00", lastModifiedAt: "2026-08-28T11:00:00" },
  { id: "JOB-1065", locationId: "wildwood-airport", serviceId: "prep-fridge", serviceName: "Prep fridge compressor service", status: "pastDue", priority: 2, scheduledFor: "2026-08-31T15:45:00", durationMinutes: 120, assigneeIds: [5, 4], equipmentIds: [], labelIds: ["ventilation", "warranty", "recurring"], type: "recall", sourceId: "corrigo", sourceRef: "COR-8711", receivedAt: "2026-08-29T09:15:00", statusChangedAt: "2026-09-02T15:00:00", lastModifiedAt: "2026-09-02T14:00:00" },
  ...
  { id: "JOB-1080", locationId: "bayside-commissary", serviceId: "fryer-service", serviceName: "Fryer service and calibration", status: "upcoming", priority: 3, scheduledFor: "2026-09-16T12:00:00", durationMinutes: 210, assigneeIds: [5, 3], equipmentIds: [], labelIds: ["plumbing", "cooking"], type: "new", sourceId: "corrigo", sourceRef: "COR-3638", receivedAt: "2026-09-03T16:15:00", statusChangedAt: "2026-09-03T10:00:00", lastModifiedAt: "2026-09-04T16:00:00" },
  { id: "JOB-1083", locationId: "mission-24th", serviceId: "steam-table", serviceName: "Steam table thermostat swap", status: "upcoming", priority: 4, scheduledFor: "2026-09-17T15:15:00", durationMinutes: 45, assigneeIds: [7], equipmentIds: [], labelIds: ["contract", "refrigeration"], type: "recall", sourceId: "direct", receivedAt: "2026-09-03T12:45:00", statusChangedAt: "2026-09-04T09:00:00", lastModifiedAt: "2026-09-04T12:00:00" },
  { id: "JOB-1049", locationId: "bayside-commissary", serviceId: "ice-machine", serviceName: "Ice machine descale", status: "upcoming", priority: 3, scheduledFor: "2026-09-18T14:00:00", durationMinutes: 210, assigneeIds: [9, 7], equipmentIds: [], labelIds: ["compliance"], type: "new", sourceId: "ecotrak", sourceRef: "ECO-2977", receivedAt: "2026-09-03T08:00:00", statusChangedAt: "2026-09-04T11:00:00", lastModifiedAt: "2026-09-04T10:00:00" },
  { id: "JOB-1048", locationId: "presidio-canteen", serviceId: "hood-cleaning", serviceName: "Grill hood cleaning", status: "upcoming", priority: 2, scheduledFor: "2026-09-20T10:45:00", durationMinutes: 180, assigneeIds: [5, 9, 8], equipmentIds: [], labelIds: [], type: "new", sourceId: "direct", receivedAt: "2026-09-03T14:15:00", statusChangedAt: "2026-09-04T11:00:00", lastModifiedAt: "2026-09-04T15:00:00" },
  { id: "JOB-1045", locationId: "northpoint-hotel", serviceId: "steam-table", serviceName: "Steam table thermostat swap", status: "upcoming", scheduledFor: "2026-09-21T07:45:00", durationMinutes: 210, assigneeIds: [6], equipmentIds: [], labelIds: [], type: "new", sourceId: "service-channel", sourceRef: "SC-5488", receivedAt: "2026-09-03T14:30:00", statusChangedAt: "2026-09-04T08:00:00", lastModifiedAt: "2026-09-04T11:00:00" },
  { id: "JOB-1050", locationId: "harbour-marina", serviceId: "ice-machine", serviceName: "Ice machine descale", status: "upcoming", scheduledFor: "2026-09-23T11:30:00", durationMinutes: 120, assigneeIds: [6, 2, 3], equipmentIds: [], labelIds: ["contract"], type: "new", sourceId: "corrigo", sourceRef: "COR-6709", receivedAt: "2026-09-03T08:15:00", statusChangedAt: "2026-09-04T17:00:00", lastModifiedAt: "2026-09-04T09:00:00" },
  { id: "JOB-1046", locationId: "northpoint-hotel", serviceId: "hood-cleaning", serviceName: "Grill hood cleaning", status: "upcoming", priority: 3, scheduledFor: "2026-09-23T15:45:00", durationMinutes: 30, assigneeIds: [5, 6, 7], equipmentIds: [], labelIds: ["plumbing", "compliance", "cooking"], type: "new", sourceId: "ecotrak", sourceRef: "ECO-3162", receivedAt: "2026-09-03T08:15:00", statusChangedAt: "2026-09-04T15:00:00", lastModifiedAt: "2026-09-04T14:00:00" },
  { id: "JOB-1044", locationId: "bayside-commissary", serviceId: "ice-machine", serviceName: "Ice machine descale", status: "upcoming", priority: 3, scheduledFor: "2026-09-25T07:00:00", durationMinutes: 180, assigneeIds: [2], equipmentIds: [], labelIds: ["quarterly"], type: "new", sourceId: "ecotrak", sourceRef: "ECO-9087", receivedAt: "2026-09-03T15:45:00", statusChangedAt: "2026-09-04T14:00:00", lastModifiedAt: "2026-09-04T12:00:00" },
  { id: "JOB-1052", locationId: "ferry-main", serviceId: "ice-machine", serviceName: "Ice machine descale", status: "unscheduled", priority: 4, assigneeIds: [], equipmentIds: [], labelIds: ["recurring"], type: "new", sourceId: "service-channel", sourceRef: "SC-1550", receivedAt: "2026-08-31T16:00:00", statusChangedAt: "2026-09-03T14:00:00", lastModifiedAt: "2026-09-04T10:00:00" },
  { id: "JOB-1053", locationId: "sunset-judah", serviceId: "prep-fridge", serviceName: "Prep fridge compressor service", status: "unscheduled", priority: 2, assigneeIds: [5], equipmentIds: [], labelIds: ["compliance", "recurring"], type: "new", sourceId: "corrigo", sourceRef: "COR-9962", receivedAt: "2026-09-03T09:15:00", statusChangedAt: "2026-09-04T12:00:00", lastModifiedAt: "2026-09-04T08:00:00" },
  ...
  { id: "JOB-1055", locationId: "wildwood-downtown", serviceId: "freezer-seal", serviceName: "Freezer door seal replacement", status: "unscheduled", priority: 1, assigneeIds: [2], equipmentIds: [], labelIds: ["warranty", "quarterly", "recurring"], type: "new", sourceId: "corrigo", sourceRef: "COR-4490", receivedAt: "2026-09-03T13:30:00", statusChangedAt: "2026-09-03T17:00:00", lastModifiedAt: "2026-09-04T15:00:00" },
  { id: "JOB-1056", locationId: "harbour-marina", serviceId: "walk-in-cooler", serviceName: "Walk-in cooler repair", status: "unscheduled", priority: 3, assigneeIds: [], equipmentIds: [], labelIds: ["warranty", "recurring", "refrigeration"], type: "new", sourceId: "direct", receivedAt: "2026-08-25T10:15:00", statusChangedAt: "2026-08-30T17:00:00", lastModifiedAt: "2026-08-31T10:00:00" },
  ...
  { id: "JOB-1058", locationId: "northpoint-banquet", serviceId: "dishwasher", serviceName: "Dishwasher inspection", status: "unscheduled", priority: 3, assigneeIds: [8], equipmentIds: [], labelIds: ["compliance", "ventilation", "plumbing"], type: "new", sourceId: "service-channel", sourceRef: "SC-1695", receivedAt: "2026-08-30T09:30:00", statusChangedAt: "2026-08-31T16:00:00", lastModifiedAt: "2026-09-01T14:00:00" },
  { id: "JOB-1075", locationId: "harbour-pier", serviceId: "combi-oven", serviceName: "Combi oven quarterly maintenance", status: "draft", priority: 3, assigneeIds: [], equipmentIds: [], labelIds: ["refrigeration", "contract"], type: "new", sourceId: "service-channel", sourceRef: "SC-8659", receivedAt: "2026-09-03T16:15:00", statusChangedAt: "2026-09-03T16:00:00", lastModifiedAt: "2026-09-04T12:00:00" },
  { id: "JOB-1088", locationId: "sunset-judah", serviceId: "walk-in-cooler", serviceName: "Walk-in cooler repair", status: "unscheduled", priority: 4, assigneeIds: [4], equipmentIds: [], labelIds: ["priority-client", "contract"], type: "recall", sourceId: "ecotrak", sourceRef: "ECO-7022", receivedAt: "2026-08-30T15:00:00", statusChangedAt: "2026-08-30T08:00:00", lastModifiedAt: "2026-08-30T17:00:00" },
  { id: "JOB-1089", locationId: "presidio-canteen", serviceId: "prep-fridge", serviceName: "Prep fridge compressor service", status: "unscheduled", priority: 2, assigneeIds: [], equipmentIds: [], labelIds: ["warranty", "priority-client"], type: "new", sourceId: "direct", receivedAt: "2026-08-27T15:15:00", statusChangedAt: "2026-08-27T16:00:00", lastModifiedAt: "2026-09-02T14:00:00" },
  ...
  { id: "JOB-1091", locationId: "presidio-canteen", serviceId: "espresso", serviceName: "Espresso machine descale", status: "unscheduled", priority: 1, assigneeIds: [5], equipmentIds: [], labelIds: ["ventilation", "warranty"], type: "new", sourceId: "service-channel", sourceRef: "SC-3785", receivedAt: "2026-08-27T11:45:00", statusChangedAt: "2026-08-27T11:00:00", lastModifiedAt: "2026-09-03T13:00:00" },
  { id: "JOB-1092", locationId: "harbour-marina", serviceId: "walk-in-cooler", serviceName: "Walk-in cooler repair", status: "unscheduled", priority: 3, assigneeIds: [], equipmentIds: [], labelIds: ["plumbing", "recurring", "quarterly"], type: "new", sourceId: "corrigo", sourceRef: "COR-6864", receivedAt: "2026-08-31T10:00:00", statusChangedAt: "2026-09-03T12:00:00", lastModifiedAt: "2026-09-04T11:00:00" },
  ...
  { id: "JOB-1094", locationId: "wildwood-airport", serviceId: "ice-machine", serviceName: "Ice machine descale", status: "unscheduled", priority: 3, assigneeIds: [], equipmentIds: [], labelIds: ["refrigeration"], type: "new", sourceId: "service-channel", sourceRef: "SC-4001", receivedAt: "2026-08-27T13:00:00", statusChangedAt: "2026-08-30T15:00:00", lastModifiedAt: "2026-09-03T08:00:00" },
];
...
export const ESTIMATES: Estimate[] = [
  ...
  { id: "EST-2201", locationId: "wildwood-downtown", jobId: "JOB-1201", serviceId: "walk-in-cooler", serviceName: "Walk-in cooler compressor replacement", status: "Sent", labelIds: ["replacement"], total: 3480.0, issuedAt: "2026-09-02T11:20:00", dueAt: "2026-10-02T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-09-02T11:20:00", lastModifiedAt: "2026-09-02T11:20:00", lastViewedAt: "2026-09-03T08:40:00" },
  { id: "EST-2202", locationId: "mission-24th", jobId: "JOB-1207", serviceId: "hood-cleaning", serviceName: "Hood deep cleaning", status: "Pending", isDraft: true, labelIds: [], total: 1250.0, issuedAt: "2026-08-30T15:00:00", dueAt: "2026-09-29T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-30T15:00:00", lastModifiedAt: "2026-09-01T09:30:00" },
  // Invoiced as INV-3104 (same 2,190.50 at North Point).
  { id: "EST-2203", locationId: "northpoint-hotel", serviceId: "freezer-seal", serviceName: "Walk-in freezer door assembly", status: "Approved", conversionPath: "invoiced", labelIds: ["replacement"], total: 2190.5, issuedAt: "2026-08-25T10:00:00", dueAt: "2026-09-24T17:00:00", downPayment: "paid", statusChangedAt: "2026-08-27T14:10:00", lastModifiedAt: "2026-08-27T14:10:00", lastViewedAt: "2026-08-27T09:15:00" },
  // Won and turned into the quarterly service job (JOB-1206).
  { id: "EST-2204", locationId: "bayside-commissary", jobId: "JOB-1206", serviceId: "combi-oven", serviceName: "Combi oven annual contract", status: "Won", conversionPath: "jobbed", labelIds: ["contract-renewal", "preventive-plan"], total: 5400.0, issuedAt: "2026-07-18T09:00:00", dueAt: "2026-08-17T17:00:00", downPayment: "paid", statusChangedAt: "2026-08-05T11:00:00", lastModifiedAt: "2026-08-05T11:00:00", lastViewedAt: "2026-07-20T13:25:00" },
  ...
  { id: "EST-2206", locationId: "sunset-judah", jobId: "JOB-1208", serviceId: "steam-table", serviceName: "Proofer thermostat + calibration", status: "Sent", labelIds: ["repair"], total: 480.0, issuedAt: "2026-08-24T12:10:00", dueAt: "2026-09-23T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-24T12:10:00", lastModifiedAt: "2026-08-24T12:10:00" },
  ...
  { id: "EST-2252", locationId: "harbour-marina", serviceId: "combi-oven", serviceName: "Combi oven quarterly maintenance", status: "Won", conversionPath: "unconverted", labelIds: [], total: 11900, issuedAt: "2026-06-14T08:30:00", dueAt: "2026-06-28T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-06-18T13:00:00", lastModifiedAt: "2026-07-11T12:00:00", lastViewedAt: "2026-07-25T17:15:00" },
  ...
  { id: "EST-2236", locationId: "wildwood-downtown", serviceId: "dishwasher", serviceName: "Dishwasher inspection", status: "Won", conversionPath: "jobbed", labelIds: [], total: 9400, issuedAt: "2026-06-26T12:30:00", dueAt: "2026-07-10T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-06T16:00:00", lastModifiedAt: "2026-08-07T09:00:00", lastViewedAt: "2026-07-29T20:15:00" },
  { id: "EST-2251", locationId: "wildwood-airport", serviceId: "hood-cleaning", serviceName: "Grill hood cleaning", status: "Won", conversionPath: "unconverted", labelIds: ["preventive-plan", "repair"], total: 4150, issuedAt: "2026-06-26T10:30:00", dueAt: "2026-07-10T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-07-05T14:00:00", lastModifiedAt: "2026-07-24T09:00:00", lastViewedAt: "2026-08-28T12:30:00" },
  ...
  { id: "EST-2220", locationId: "northpoint-banquet", serviceId: "dishwasher", serviceName: "Dishwasher inspection", status: "Won", conversionPath: "unconverted", labelIds: [], total: 9857, issuedAt: "2026-06-08T12:00:00", dueAt: "2026-07-23T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-07-12T13:00:00", lastModifiedAt: "2026-08-04T12:00:00" },
  { id: "EST-2235", locationId: "northpoint-hotel", serviceId: "freezer-seal", serviceName: "Freezer door seal replacement", status: "Won", conversionPath: "jobbed", labelIds: [], total: 3538, issuedAt: "2026-07-15T10:00:00", dueAt: "2026-07-29T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-31T13:00:00", lastModifiedAt: "2026-09-03T10:00:00", lastViewedAt: "2026-07-26T20:15:00" },
  { id: "EST-2219", locationId: "wildwood-airport", serviceId: "freezer-seal", serviceName: "Freezer door seal replacement", status: "Won", conversionPath: "invoiced", labelIds: ["preventive-plan"], total: 8800, issuedAt: "2026-06-22T10:00:00", dueAt: "2026-08-06T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-07-18T16:00:00", lastModifiedAt: "2026-08-23T13:00:00", lastViewedAt: "2026-07-05T09:45:00" },
  ...
  { id: "EST-2227", locationId: "wildwood-downtown", serviceId: "range-burner", serviceName: "Range burner repair", status: "Sent", labelIds: [], total: 5500, issuedAt: "2026-07-30T15:45:00", dueAt: "2026-08-13T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-08-03T14:00:00", lastModifiedAt: "2026-08-13T17:00:00", lastViewedAt: "2026-08-16T16:30:00" },
  { id: "EST-2250", locationId: "mission-24th", serviceId: "ice-machine", serviceName: "Ice machine descale", status: "Approved", conversionPath: "unconverted", labelIds: [], total: 1250, issuedAt: "2026-07-24T11:30:00", dueAt: "2026-08-14T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-22T15:00:00", lastModifiedAt: "2026-08-31T13:00:00", lastViewedAt: "2026-08-14T16:30:00" },
  { id: "EST-2255", locationId: "wildwood-downtown", serviceId: "grease-trap", serviceName: "Grease trap service", status: "Sent", labelIds: [], total: 10301, issuedAt: "2026-08-02T10:45:00", dueAt: "2026-08-16T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-09-02T15:00:00", lastModifiedAt: "2026-09-02T12:00:00" },
  ...
  { id: "EST-2242", locationId: "northpoint-hotel", serviceId: "steam-table", serviceName: "Steam table thermostat swap", status: "Sent", labelIds: ["preventive-plan"], total: 10738, issuedAt: "2026-07-30T17:00:00", dueAt: "2026-08-20T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-01T17:00:00", lastModifiedAt: "2026-09-03T12:00:00", lastViewedAt: "2026-08-27T13:00:00" },
  { id: "EST-2225", locationId: "harbour-marina", serviceId: "ice-machine", serviceName: "Ice machine descale", status: "Sent", labelIds: [], total: 6505, issuedAt: "2026-08-07T08:00:00", dueAt: "2026-08-21T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-09-04T17:00:00", lastModifiedAt: "2026-09-04T15:00:00" },
  { id: "EST-2234", locationId: "wildwood-downtown", serviceId: "prep-fridge", serviceName: "Prep fridge compressor service", status: "Approved", conversionPath: "jobbed", labelIds: ["parts-only", "contract-renewal"], total: 11900, issuedAt: "2026-08-10T08:15:00", dueAt: "2026-08-24T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-24T12:00:00", lastModifiedAt: "2026-08-26T15:00:00", lastViewedAt: "2026-08-26T13:30:00" },
  ...
  { id: "EST-2249", locationId: "wildwood-downtown", serviceId: "grease-trap", serviceName: "Grease trap service", status: "Approved", conversionPath: "unconverted", labelIds: ["preventive-plan"], total: 8100, issuedAt: "2026-08-11T15:45:00", dueAt: "2026-08-25T17:00:00", downPayment: "partiallyPaid", statusChangedAt: "2026-08-11T17:00:00", lastModifiedAt: "2026-08-31T09:00:00", lastViewedAt: "2026-08-23T09:45:00" },
  { id: "EST-2241", locationId: "presidio-canteen", serviceId: "fryer-service", serviceName: "Fryer service and calibration", status: "Sent", labelIds: ["labor-only"], total: 5976, issuedAt: "2026-08-12T16:45:00", dueAt: "2026-08-26T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-08-29T17:00:00", lastModifiedAt: "2026-09-01T13:00:00", lastViewedAt: "2026-08-22T08:15:00" },
  { id: "EST-2216", locationId: "northpoint-banquet", serviceId: "freezer-seal", serviceName: "Freezer door seal replacement", status: "Approved", conversionPath: "jobbed", labelIds: ["contract-renewal"], total: 3179, issuedAt: "2026-08-07T08:30:00", dueAt: "2026-08-28T17:00:00", downPayment: "partiallyPaid", statusChangedAt: "2026-08-17T12:00:00", lastModifiedAt: "2026-08-28T08:00:00", lastViewedAt: "2026-08-26T21:30:00" },
  { id: "EST-2207", locationId: "ferry-main", serviceId: "hood-cleaning", serviceName: "Grill hood cleaning", status: "Sent", labelIds: ["parts-only"], total: 9300, issuedAt: "2026-08-15T11:30:00", dueAt: "2026-08-29T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-08-27T09:00:00", lastModifiedAt: "2026-08-31T15:00:00", lastViewedAt: "2026-09-02T14:00:00" },
  { id: "EST-2208", locationId: "harbour-marina", serviceId: "espresso", serviceName: "Espresso machine descale", status: "Sent", labelIds: ["warranty-claim"], total: 1300, issuedAt: "2026-07-30T09:45:00", dueAt: "2026-08-29T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-08-22T08:00:00", lastModifiedAt: "2026-08-25T08:00:00", lastViewedAt: "2026-08-05T12:45:00" },
  ...
  { id: "EST-2239", locationId: "ferry-main", serviceId: "prep-fridge", serviceName: "Prep fridge compressor service", status: "Sent", labelIds: [], total: 11350, issuedAt: "2026-08-07T17:00:00", dueAt: "2026-09-06T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-16T13:00:00", lastModifiedAt: "2026-08-29T09:00:00" },
  { id: "EST-2229", locationId: "northpoint-banquet", serviceId: "combi-oven", serviceName: "Combi oven quarterly maintenance", status: "Pending", isDraft: true, labelIds: ["contract-renewal", "preventive-plan"], total: 11710, issuedAt: "2026-08-24T09:15:00", dueAt: "2026-09-07T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-08-26T13:00:00", lastModifiedAt: "2026-09-02T08:00:00" },
  { id: "EST-2248", locationId: "harbour-marina", serviceId: "ice-machine", serviceName: "Ice machine descale", status: "Approved", conversionPath: "unconverted", labelIds: ["contract-renewal"], total: 2259, issuedAt: "2026-08-17T16:15:00", dueAt: "2026-09-07T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-31T08:00:00", lastModifiedAt: "2026-09-04T10:00:00", lastViewedAt: "2026-08-27T08:30:00" },
  { id: "EST-2212", locationId: "sunset-judah", serviceId: "espresso", serviceName: "Espresso machine descale", status: "Pending", labelIds: ["replacement"], total: 2764, issuedAt: "2026-08-27T08:30:00", dueAt: "2026-09-10T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-09-01T13:00:00", lastModifiedAt: "2026-09-03T17:00:00" },
  { id: "EST-2214", locationId: "wildwood-airport", serviceId: "fryer-service", serviceName: "Fryer service and calibration", status: "Pending", isDraft: true, labelIds: ["repair"], total: 9257, issuedAt: "2026-08-24T11:15:00", dueAt: "2026-09-14T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-09-02T11:00:00", lastModifiedAt: "2026-09-02T08:00:00" },
  { id: "EST-2226", locationId: "harbour-pier", serviceId: "hood-cleaning", serviceName: "Grill hood cleaning", status: "Sent", labelIds: ["budgetary"], total: 550, issuedAt: "2026-07-31T16:30:00", dueAt: "2026-09-14T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-02T14:00:00", lastModifiedAt: "2026-08-28T09:00:00" },
  { id: "EST-2259", locationId: "harbour-pier", serviceId: "hood-cleaning", serviceName: "Grill hood cleaning", status: "Sent", labelIds: ["labor-only", "warranty-claim"], total: 10076, issuedAt: "2026-08-24T12:30:00", dueAt: "2026-09-14T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-09-04T16:00:00", lastModifiedAt: "2026-09-04T09:00:00" },
  { id: "EST-2233", locationId: "mission-24th", serviceId: "grease-trap", serviceName: "Grease trap service", status: "Approved", conversionPath: "unconverted", labelIds: ["parts-only", "replacement"], total: 8000, issuedAt: "2026-08-25T08:15:00", dueAt: "2026-09-15T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-29T11:00:00", lastModifiedAt: "2026-09-04T15:00:00", lastViewedAt: "2026-08-30T10:15:00" },
  { id: "EST-2260", locationId: "harbour-marina", serviceId: "steam-table", serviceName: "Steam table thermostat swap", status: "Pending", labelIds: ["parts-only", "preventive-plan"], total: 5350, issuedAt: "2026-08-25T08:15:00", dueAt: "2026-09-15T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-09-03T15:00:00", lastModifiedAt: "2026-09-03T17:00:00" },
  { id: "EST-2240", locationId: "sunset-judah", serviceId: "dishwasher", serviceName: "Dishwasher inspection", status: "Sent", labelIds: ["contract-renewal", "parts-only"], total: 1450, issuedAt: "2026-08-17T16:45:00", dueAt: "2026-09-16T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-08-30T09:00:00", lastModifiedAt: "2026-09-03T10:00:00", lastViewedAt: "2026-09-04T09:45:00" },
  { id: "EST-2245", locationId: "northpoint-hotel", serviceId: "range-burner", serviceName: "Range burner repair", status: "Pending", labelIds: ["replacement", "contract-renewal"], total: 9900, issuedAt: "2026-08-26T10:45:00", dueAt: "2026-09-16T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-31T12:00:00", lastModifiedAt: "2026-09-02T10:00:00" },
  { id: "EST-2247", locationId: "ferry-main", serviceId: "walk-in-cooler", serviceName: "Walk-in cooler repair", status: "Pending", labelIds: ["budgetary"], total: 3150, issuedAt: "2026-08-27T16:15:00", dueAt: "2026-09-17T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-09-01T11:00:00", lastModifiedAt: "2026-09-02T13:00:00" },
  { id: "EST-2261", locationId: "wildwood-airport", serviceId: "hood-cleaning", serviceName: "Grill hood cleaning", status: "Pending", labelIds: [], total: 3950, issuedAt: "2026-08-27T11:30:00", dueAt: "2026-09-17T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-09-02T11:00:00", lastModifiedAt: "2026-09-02T08:00:00" },
  { id: "EST-2217", locationId: "harbour-marina", serviceId: "range-burner", serviceName: "Range burner repair", status: "Approved", conversionPath: "jobbed", labelIds: [], total: 10692, issuedAt: "2026-08-07T09:15:00", dueAt: "2026-09-21T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-09-04T09:00:00", lastModifiedAt: "2026-09-04T14:00:00", lastViewedAt: "2026-08-13T08:15:00" },
  { id: "EST-2246", locationId: "ferry-main", serviceId: "dishwasher", serviceName: "Dishwasher inspection", status: "Pending", labelIds: ["parts-only"], total: 5219, issuedAt: "2026-08-31T09:45:00", dueAt: "2026-09-21T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-09-04T09:00:00", lastModifiedAt: "2026-09-04T11:00:00" },
  { id: "EST-2262", locationId: "northpoint-hotel", serviceId: "walk-in-cooler", serviceName: "Walk-in cooler repair", status: "Pending", labelIds: ["contract-renewal"], total: 8650, issuedAt: "2026-08-23T11:00:00", dueAt: "2026-09-22T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-31T17:00:00", lastModifiedAt: "2026-08-31T16:00:00" },
  { id: "EST-2257", locationId: "northpoint-banquet", serviceId: "combi-oven", serviceName: "Combi oven quarterly maintenance", status: "Sent", labelIds: ["labor-only", "warranty-claim"], total: 3937, issuedAt: "2026-08-25T13:45:00", dueAt: "2026-09-24T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-25T13:00:00", lastModifiedAt: "2026-09-04T13:00:00", lastViewedAt: "2026-08-29T19:15:00" },
  { id: "EST-2211", locationId: "harbour-pier", serviceId: "grease-trap", serviceName: "Grease trap service", status: "Sent", labelIds: [], total: 6800, issuedAt: "2026-08-26T10:15:00", dueAt: "2026-09-25T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-09-04T14:00:00", lastModifiedAt: "2026-09-04T11:00:00", lastViewedAt: "2026-08-28T20:00:00" },
  { id: "EST-2215", locationId: "mission-24th", serviceId: "freezer-seal", serviceName: "Freezer door seal replacement", status: "Pending", labelIds: ["warranty-claim"], total: 1563, issuedAt: "2026-08-26T15:15:00", dueAt: "2026-09-25T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-09-04T08:00:00", lastModifiedAt: "2026-09-04T09:00:00" },
  { id: "EST-2244", locationId: "presidio-canteen", serviceId: "espresso", serviceName: "Espresso machine descale", status: "Pending", isDraft: true, labelIds: ["replacement"], total: 7530, issuedAt: "2026-08-26T08:30:00", dueAt: "2026-09-25T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-28T14:00:00", lastModifiedAt: "2026-08-28T16:00:00" },
  { id: "EST-2228", locationId: "northpoint-banquet", serviceId: "dishwasher", serviceName: "Dishwasher inspection", status: "Pending", labelIds: [], total: 7000, issuedAt: "2026-08-28T17:15:00", dueAt: "2026-09-27T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-28T11:00:00", lastModifiedAt: "2026-09-01T10:00:00" },
  { id: "EST-2224", locationId: "northpoint-hotel", serviceId: "fryer-service", serviceName: "Fryer service and calibration", status: "Sent", labelIds: [], total: 1000, issuedAt: "2026-08-14T11:30:00", dueAt: "2026-09-28T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-16T13:00:00", lastModifiedAt: "2026-09-01T09:00:00" },
  { id: "EST-2232", locationId: "ferry-main", serviceId: "combi-oven", serviceName: "Combi oven quarterly maintenance", status: "Approved", conversionPath: "unconverted", labelIds: [], total: 3650, issuedAt: "2026-08-15T08:30:00", dueAt: "2026-09-29T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-15T08:00:00", lastModifiedAt: "2026-08-19T11:00:00", lastViewedAt: "2026-08-18T09:30:00" },
  { id: "EST-2256", locationId: "northpoint-hotel", serviceId: "fryer-service", serviceName: "Fryer service and calibration", status: "Sent", labelIds: [], total: 5350, issuedAt: "2026-08-30T13:30:00", dueAt: "2026-09-29T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-08-30T15:00:00", lastModifiedAt: "2026-09-03T16:00:00", lastViewedAt: "2026-09-01T11:45:00" },
  { id: "EST-2223", locationId: "presidio-canteen", serviceId: "walk-in-cooler", serviceName: "Walk-in cooler repair", status: "Sent", labelIds: ["parts-only"], total: 6810, issuedAt: "2026-09-01T08:00:00", dueAt: "2026-10-01T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-09-04T14:00:00", lastModifiedAt: "2026-09-04T10:00:00" },
  { id: "EST-2209", locationId: "bayside-commissary", serviceId: "dishwasher", serviceName: "Dishwasher inspection", status: "Sent", labelIds: [], total: 7750, issuedAt: "2026-08-20T10:15:00", dueAt: "2026-10-04T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-20T16:00:00", lastModifiedAt: "2026-09-02T17:00:00", lastViewedAt: "2026-08-22T12:30:00" },
  { id: "EST-2243", locationId: "sunset-judah", serviceId: "freezer-seal", serviceName: "Freezer door seal replacement", status: "Sent", labelIds: ["warranty-claim", "replacement"], total: 6200, issuedAt: "2026-08-23T15:45:00", dueAt: "2026-10-07T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-23T14:00:00", lastModifiedAt: "2026-08-28T16:00:00" },
  { id: "EST-2218", locationId: "northpoint-hotel", serviceId: "espresso", serviceName: "Espresso machine descale", status: "Approved", conversionPath: "invoiced", labelIds: ["warranty-claim", "budgetary"], total: 8800, issuedAt: "2026-08-24T10:15:00", dueAt: "2026-10-08T17:00:00", downPayment: "partiallyPaid", statusChangedAt: "2026-08-31T17:00:00", lastModifiedAt: "2026-09-04T16:00:00", lastViewedAt: "2026-08-27T10:00:00" },
  { id: "EST-2230", locationId: "harbour-pier", serviceId: "combi-oven", serviceName: "Combi oven quarterly maintenance", status: "Pending", labelIds: ["warranty-claim", "budgetary"], total: 1650, issuedAt: "2026-08-24T14:15:00", dueAt: "2026-10-08T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-08-29T12:00:00", lastModifiedAt: "2026-08-30T12:00:00" },
  { id: "EST-2258", locationId: "wildwood-downtown", serviceId: "steam-table", serviceName: "Steam table thermostat swap", status: "Sent", labelIds: ["parts-only", "budgetary"], total: 5269, issuedAt: "2026-08-24T08:45:00", dueAt: "2026-10-08T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-08-24T12:00:00", lastModifiedAt: "2026-09-01T16:00:00" },
  { id: "EST-2210", locationId: "ferry-main", serviceId: "prep-fridge", serviceName: "Prep fridge compressor service", status: "Sent", labelIds: ["warranty-claim"], total: 1700, issuedAt: "2026-08-26T17:15:00", dueAt: "2026-10-10T17:00:00", downPayment: "unpaid", statusChangedAt: "2026-09-01T14:00:00", lastModifiedAt: "2026-09-01T17:00:00" },
  { id: "EST-2213", locationId: "harbour-pier", serviceId: "grease-trap", serviceName: "Grease trap service", status: "Pending", labelIds: [], total: 300, issuedAt: "2026-08-29T08:45:00", dueAt: "2026-10-13T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-09-01T12:00:00", lastModifiedAt: "2026-09-01T17:00:00" },
  { id: "EST-2231", locationId: "presidio-canteen", serviceId: "range-burner", serviceName: "Range burner repair", status: "Pending", labelIds: ["repair"], total: 3750, issuedAt: "2026-08-31T14:30:00", dueAt: "2026-10-15T17:00:00", downPayment: "notRequired", statusChangedAt: "2026-09-01T12:00:00", lastModifiedAt: "2026-09-01T14:00:00" },
];
